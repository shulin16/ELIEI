...
from data.dataset import LoL_Dataset, LoL_Dataset_v2, IR_Dataset
...
def main():
    ...
    parser.add_argument('--opt', type=str, help='Path to option YMAL file.',
                            default='/home/yufei/shulin/ELILI/code/confs/IR_smallNet.yml' if sys.platform != 'win32' else './confs/LOL_smallNet.yml') #  './confs/LOLv2-pc_rebuttal.yml') # 
